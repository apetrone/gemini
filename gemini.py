class gemini(Builder):
	def setup(self, platform, builder):
		...
		self.builder_type = DefaultDict( Builder.Bundle )
	...
	def config(self, builder, driver, project, args):
		...
		builder.setOutput( path=bindir, name=self.build_name, type=self.builder_type[ args["platform"] ] )
