...
void main()
{
	...
	color = texture2D( diffusemap, ps_uv0 );
#elif defined(D_CUBEMAP)
	color = textureCube( cubemap, ps_CubeVertex );
#endif
	...
	specularColor = texture2D( specularmap, ps_uv0 );
	...
	gl_FragColor = color + specularContribution;
}