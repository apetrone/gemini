...
void main()
{
	...
	// final_vertex += (node_transforms[in_blendindices.x] * in_position) * in_blendweights.x;
	// final_vertex += (node_transforms[in_blendindices.y] * in_position) * in_blendweights.y;
	// final_vertex += (node_transforms[in_blendindices.z] * in_position) * in_blendweights.z;
	// final_vertex += (node_transforms[in_blendindices.w] * in_position) * in_blendweights.w;
