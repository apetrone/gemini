...
def arguments(parser):
	...
	parser.add_argument("--no-x-importer",			dest="no-x-importer",		action="store_true", default=import_default,		help="Omit the X file importer")
	parser.add_argument("--no-3ds-importer",		dest="no-3ds-importer",		action="store_true", default=import_default,		help="Omit the 3DS file importer")
	parser.add_argument("--no-md3-importer",		dest="no-md3-importer",		action="store_true", default=import_default,		help="Omit the MD3 file importer")
	parser.add_argument("--no-mdl-importer",		dest="no-mdl-importer",		action="store_true", default=import_default,		help="Omit the MDL file importer")
	parser.add_argument("--no-md2-importer",		dest="no-md2-importer",		action="store_true", default=import_default,		help="Omit the MD2 file importer")
	parser.add_argument("--no-ply-importer",		dest="no-ply-importer",		action="store_true", default=import_default,		help="Omit the PLY file importer")
	parser.add_argument("--no-ase-importer",		dest="no-ase-importer",		action="store_true", default=import_default,		help="Omit the ASE file importer")
	parser.add_argument("--no-obj-importer",		dest="no-obj-importer",		action="store_true", default=import_default,		help="Omit the OBJ file importer")
	parser.add_argument("--no-hmp-importer",		dest="no-hmp-importer",		action="store_true", default=import_default,		help="Omit the HMP file importer")
	parser.add_argument("--no-smd-importer",		dest="no-smd-importer",		action="store_true", default=import_default,		help="Omit the SMD file importer")
	parser.add_argument("--no-mdc-importer",		dest="no-mdc-importer",		action="store_true", default=import_default,		help="Omit the MDC file importer")
	parser.add_argument("--no-md5-importer",		dest="no-md5-importer",		action="store_true", default=import_default,		help="Omit the MD5 file importer")
	parser.add_argument("--no-stl-importer",		dest="no-stl-importer",		action="store_true", default=import_default,		help="Omit the STL file importer")
	parser.add_argument("--no-lwo-importer",		dest="no-lwo-importer",		action="store_true", default=import_default,		help="Omit the LWO file importer")
	parser.add_argument("--no-dxf-importer",		dest="no-dxf-importer",		action="store_true", default=import_default,		help="Omit the DXF file importer")
	parser.add_argument("--no-nff-importer",		dest="no-nff-importer",		action="store_true", default=import_default,		help="Omit the NFF file importer")
	parser.add_argument("--no-raw-importer",		dest="no-raw-importer",		action="store_true", default=import_default,		help="Omit the RAW file importer")
	parser.add_argument("--no-off-importer",		dest="no-off-importer",		action="store_true", default=import_default,		help="Omit the OFF file importer")
	parser.add_argument("--no-ac-importer",			dest="no-ac-importer",		action="store_true", default=import_default,		help="Omit the AC file importer")
	parser.add_argument("--no-bvh-importer",		dest="no-bvh-importer",		action="store_true", default=import_default,		help="Omit the BVH file importer")
	parser.add_argument("--no-irrmesh-importer",	dest="no-irrmesh-importer",	action="store_true", default=import_default,		help="Omit the irrmesh file importer")
	parser.add_argument("--no-irr-importer",		dest="no-irr-importer",		action="store_true", default=import_default,		help="Omit the irr file importer")
	parser.add_argument("--no-q3d-importer",		dest="no-q3d-importer",		action="store_true", default=import_default,		help="Omit the Q3D file importer")
	parser.add_argument("--no-b3d-importer",		dest="no-b3d-importer",		action="store_true", default=import_default,		help="Omit the b3d file importer")
	parser.add_argument("--no-collada-importer",	dest="no-collada-importer",		action="store_true", default=import_default,		help="Omit the COLLADA file importer")
	parser.add_argument("--no-terragen-importer",	dest="no-terragen-importer",		action="store_true", default=import_default,		help="Omit the terragen file importer")
	parser.add_argument("--no-csm-importer",		dest="no-csm-importer",		action="store_true", default=import_default,		help="Omit the csm file importer")
	parser.add_argument("--no-3d-importer",			dest="no-3d-importer",		action="store_true", default=import_default,		help="Omit the 3d file importer")
	parser.add_argument("--no-lws-importer",		dest="no-lws-importer",		action="store_true", default=import_default,		help="Omit the lws file importer")
	parser.add_argument("--no-ogre-importer",		dest="no-ogre-importer",		action="store_true", default=import_default,		help="Omit the ogre file importer")
	parser.add_argument("--no-ms3d-importer",		dest="no-ms3d-importer",		action="store_true", default=import_default,		help="Omit the ms3d file importer")
	parser.add_argument("--no-cob-importer",		dest="no-cob-importer",		action="store_true", default=import_default,		help="Omit the cob file importer")
	parser.add_argument("--no-blend-importer",		dest="no-blend-importer",		action="store_true", default=import_default,		help="Omit the blend file importer")
	parser.add_argument("--no-q3bsp-importer",		dest="no-q3bsp-importer",		action="store_true", default=import_default,		help="Omit the q3bsp file importer")
	parser.add_argument("--no-ndo-importer",		dest="no-ndo-importer",		action="store_true", default=import_default,		help="Omit the ndo file importer")
	parser.add_argument("--no-ifc-importer",		dest="no-ifc-importer",		action="store_true", default=import_default,		help="Omit the ifc file importer")
	parser.add_argument("--no-xgl-importer",		dest="no-xgl-importer",		action="store_true", default=import_default,		help="Omit the xgl file importer")
	parser.add_argument("--no-fbx-importer",		dest="no-fbx-importer",		action="store_true", default=import_default,		help="Omit the FBX file importer")
